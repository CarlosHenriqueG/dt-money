...
const mewTransactionFormSchema = z.object({
...
type NewTransactionFormInputs = z.infer<typeof mewTransactionFormSchema>;
...
export function NewTransactionModal() {
  ...
  const {
    ...
    resolver: zodResolver(mewTransactionFormSchema),
    defaultValues: {
      type: "income",
    },
  });
